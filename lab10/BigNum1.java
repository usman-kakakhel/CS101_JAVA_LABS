...
public class BigNum1
{
  ...
  public BigNum1(BigNum forClone)
  {
    arrayOfData = new int[SIZE];
  ...
  public BigNum add(BigNum other) 
  {
    ...
    for (int x = 0; x < SIZE; x++) 
    {
      ...
      {
        other.arrayOfData[x] = (other.getArrayOfData()[x] + arrayOfData[x] + carry) - BASE;
        carry = 1;
      }
      else
      {
        other.arrayOfData[x] = other.getArrayOfData()[x] + arrayOfData[x] + carry;
        carry = 0;
      }
    }
    return other;
